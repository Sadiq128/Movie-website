    ...
    render() {
        ...
        return (
            <div>
                ...
                <footer>
                    Copyright @2023<br/>Creator - Sadiq-Basha<br/>Connect Me<br/>
                    <a href="https://www.linkedin.com/in/muhammad-sadiq-7b27b4270/"><i className="fab fa-linkedin-in"></i></a>
                    <a href="https://codepen.io/sadiq-Basha"><i className="fab fa-codepen"></i></a>
                    <a href="https://github.com/Sadiq128"><i className="fab fa-github"></i></a>
                </footer>
            </div>
        )
    }
